...
// СДЕЛАТЬ В ЭТОМ VC ВСЕ ЧТО СВЯЗАННО С КАРТИНКОЙ В NavBar и отнаследовать

class LogoTableViewController: UITableViewController {
...
extension LogoTableViewController {
